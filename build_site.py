...
<section class="hero"><div class="wrap">
  ...
  <p class="lead">OneBrowse is a browser for the one or two sites you actually use. Pin a site, tap its button, and everything it throws at you — pop-ups, redirects, overlays, cookie walls — is stopped before you see it.</p>
...
<section class="features"><div class="wrap">
  ...
  <div class="grid">
    ...
    <div class="card"><h3>On every device</h3><p>iPhone, iPad and Mac. Sign in with Apple if you want your pinned sites, favourites and settings to follow you over iCloud. No account is needed to use the app.</p></div>
